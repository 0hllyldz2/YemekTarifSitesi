...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style8"><strong>Yemek Göeüntü:</strong></td>
        ...
        <tr>
            <td class="auto-style6">&nbsp;</td>
            <td>
                <asp:Button ID="Button2" runat="server" CssClass="auto-style4" OnClick="Button2_Click" Text="Günün Yemeği Seç" Width="270px" />
            </td>
        </tr>
        <tr>
            <td class="auto-style6">&nbsp;</td>
