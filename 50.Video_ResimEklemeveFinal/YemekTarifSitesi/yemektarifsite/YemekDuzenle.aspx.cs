...
public partial class YemekDuzenle : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand komut3 = new SqlCommand("UPDATE Tbl_Yemekler SET YemekAd=@p1, YemekMalzeme=@p2, YemekTarif=@p3, Kategoriid=@p4, YemekResim=@p5 WHERE Yemekid=@p6", bgl.baglanti());
        ...
        komut3.Parameters.AddWithValue("@p5", "~/image/" + FileUpload1.FileName);
