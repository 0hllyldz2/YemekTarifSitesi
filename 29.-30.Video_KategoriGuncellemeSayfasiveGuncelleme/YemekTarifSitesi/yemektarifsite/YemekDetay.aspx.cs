...
public partial class YemekDetay : System.Web.UI.Page
{
    ...
    {
        SqlCommand komut4 = new SqlCommand("INSERT INTO Tbl_Yorumlar (YorumAdSoyad, YorumMail, Yorumİcerik, Yemekid) VALUES (@p1, @p2, @p3, @p4)", bgl.baglanti());
        ...
        komut4.Parameters.AddWithValue("@p4", yemekid);
